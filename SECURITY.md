...
If you discover a security vulnerability, please report it by emailing the maintainers at security@example.com (TODO: REPLACE_WITH_PROJECT_EMAIL). You can expect:

1. **Acknowledgment**: We'll acknowledge receipt of your vulnerability report within 48 hours.
2. **Updates**: We'll send you regular updates about our progress, at least every 7 days.
...
- Be mindful of potential cryptographic weaknesses when implementing or using cryptographic algorithms.
