...
Breadcrumb: Architecture > Automation > Master Agent Prompt
...
--- This document seeds the system prompt for maintenance agents. Keep it updated as architecture evolves.
