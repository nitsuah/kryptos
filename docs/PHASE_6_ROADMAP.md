...
- **K3 Transposition** - BLOCKER: Can't crack known transposition (2-3 days)
- **Real OPS Execution** - BLOCKER: Placeholders prevent production use (2-3 days)
- **K2 Alphabet Variants** - Code exists, needs wiring (2-3 days)
