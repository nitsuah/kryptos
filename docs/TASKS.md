...
- [x] **P14 — CIA→Berlin great-circle bearing as cipher parameter** — Bearing from CIA HQ (38°57'N, 77°8'W) to Berlin (52°31'N, 13°24'E) is ~44.4°. Test 44 as: Caesar shift (44 mod 26 = 18 = S), clock minute offset (44 min from CIA timestamp), Vigenère key cycle offset by 44 positions. Three lightweight tests against the 4-crib gate.
