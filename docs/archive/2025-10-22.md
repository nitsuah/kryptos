...
Top priorities (next iteration):
 ...
 - [ ] 3) Wire and validate a deterministic tiny tuning sweep (`kryptos.k4.tuning.run_crib_weight_sweep`
...
- Day 0–1 (3–6 hours): validate the deterministic tuning sweep
  (`kryptos.k4.tuning.run_crib_weight_sweep`) with a small grid and verify CSV artifacts are produced.
