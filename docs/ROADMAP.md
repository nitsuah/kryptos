...
- **The remaining ~7 of 24 segments of the World Clock city list** (104 of 146 confirmed as of 2026-09-02, up from 9 — count also resolved to 146+1 IDL=147, not 148, via convergent German+English Wikipedia; both closed by directly reading 5 Wikimedia Commons plate photographs, not a text summary). Missing: Japan/Korea/Australia/NZ, Pacific/Hawaii, one Middle East/North Africa gap. Next: more Commons photos, the 360cities.net panorama. (Patent DE2515102A1 was checked and is unrelated.)
